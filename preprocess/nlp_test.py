...
expected_output = """
第八章５７ «Cecilus Segmunt»





 --Cecilus Segmuntは«Stargazer»である。

 この書き出しはすでにしたので没とする。



 --Cecilus Segmuntはこの世界の花形役者である。

 この事実は語るより魅せるで証明し続けているので野暮とする。



 --Cecilus Segmuntはこの世に唯一無二である。

 この主張はCecilusに限った話ではないので頭痛が痛い的な話である。





 --Cecilus SegmuntはCecilus Segmuntである。
 ...
 テンチシンメーに誓い、この事実は決して揺るがざるCecilusの大前提だ。

 たとえ我が身に何が起こっていようと、周りのものたちが言っていたように、今より手足のすらりと長い見目の整った華のある美青年たる大人の自分がいたんだとしても、それはもはやビフォア・Cecilusであり、今この瞬間、Cecilus Segmuntとは自分という個のみしか存在しないのである。

 故に、それを証明する。



"天上のObserversも照覧あれ。--世界がいずれを選ぶかを"



 ギュッと服の切れ端で髪をまとめ終え、空いた両手で自分の頬を強く張る。

 こうした気合いの入れ方をCecilusは滅多にしないが、誰の目にもわかりやすい気持ちの変化は作劇上とても重要だ。このような描写を挟むことで、見ている側に舞台が役者の気持ちの変化を伴い、次のシーンへ移行したと知らしめられる。

 それをしてから、"そう言えば"とCecilusは首をひねり、
...
«●●■▼●■●！»«▼■■--»«■■■■■！！»«▲■■▲●●●■▲●●▲▼■●▲■■●●●»«●■●●■■■！»«--▲▼▲»«●●▲▼▲●●»«■●▲●■■●●▲■●！ ●■●！ ▲▼■！»«●●■■■▼●■--»
 ...
 途端、沈黙を強いられていた観客たちの声が爆発し、Cecilusはうんうんとそれらの平常運転に内心で頷きながら自分の調子を取り戻す。

 常日頃、自分に釘付けな彼らの存在に承認欲求を満たされ続けるCecilusだが、ああして彼らを黙らせたのは先ほどが初めてのことだった。自分でも思いがけない行動だったが、あんな風に押し黙るなんて彼らもよほど驚いたに違いない。
...
"セシ--"
 ...
 ニヤリと笑った顔の中心、それを穿たれたCecilusの姿にAlが声を上げる。

 駆け寄ってきていた彼は、そのCecilusの姿に何故か自分の首に宛がっているBlue Dragon Swordに力を込めようとした。が、寸前で思いとどまる。

 顔を貫かれたCecilusの像がブレ、死んだのが残像だと理解したからだ。
...
"少し離れていた方がいいですよ"
 ...
 そうAlの鼓膜に届けた直後、Cecilusの残像が弾け、衝撃波が広がる。
...
"うおああああ！？"
 ...
 攻撃が生んだ余波、それに巻き込まれるAlの悲鳴が尾を引くが、前を向くCecilusはそれを視界の端にも収めない。ただ、その存在を完全に無視もしない。

 Alのこれまでの挙動と身体能力、直前の立ち位置と聞こえた悲鳴の遠ざかり方、そうした周辺情報を拾い、相手の攻撃の形質から導き出される自然な演出効果として、Cecilusは見えていないAlの姿を脳内劇場に思い描く。
 ...
 Cecilusは自分の立ち位置を舞台の中心と定め、その上で配役された役者たちの立ち回りや舞台効果を自分好みに演出、すなわち世界的に最も映える展開の実現へひた走る。
...
"----"
 ...
 死線を走るCecilus、その頭上を浮遊するヒロインの異形化が進む。

 Cecilusの渾身の手刀を浴びてもビクともしなかったヒロインは、その細い肩や腕に細かな魔晶石を幾本も生やし、輝く翼を纏ったような幻想的な姿と化していた。

 その美しいとすら言える姿の中、特に目を引くのはヒロインの周囲に浮かび上がり、柔らかく空を撫でている光の帯--それは、薄く平たく構築された魔晶石だ。



 如何なる原理か、燃える街並みの赤に照らし返される魔性の帯は、風になびく薄絹のような軌道で空を泳ぎ、刹那、世界を縦断してCecilusへ放たれる。

 先の、Alが吹き飛んだ一撃と同じ代物、それが目を輝かせたCecilusの顔面へと再び迫り、迫り、迫り--、
...
"--ぺろり。なるほどこれはおかしな味わい。なんというか宝石味？"
 ...
 刹那、Cecilusはつんと伸ばした舌先で、顔の中心を穿たれる寸前で躱した帯の味を確かめた。舌先の感触は柔らかいのに硬く、その味は言葉通りで宝石に近い。
...
"そう言えば序盤は光やら火やらを飛ばしてきていたのが途中から石の柱に土の手足と変わってましたね。宝石もその延長線ということですか……実に雅で僕好み！ いいですねいいですねクライマックス度が高まります！"
 ...
 帯をねぶった舌を引っ込めて、Cecilusは気分の高揚に呵々大笑。

 この土壇場、大勝負の場面で相手するのが宝石の羽衣を纏った天女とは恐れ入る。加えて先ほどの攻防の結果にも勝手に合点がいった。

 雷速で放たれたCecilusの手刀は、石の壁どころか鉄の城さえ両断する威力があった。だが、それこそ宝石の中にはそれらより硬い代物もあるとかないとか聞く。

 すなわち、Cecilusが相手するヒロインは--、
...
"--金剛石の天女！！"
 ...
 閃き、世界を両断しながら押し寄せる光の帯--都合十二本、躱して舐めた一本を省いて十一本が、Cecilusを包み殺すように四方八方十一方から襲いくる。
...
"それが必要とあらば！ 雨粒だろうと砂粒だろうとよけましょう！"
 ...
 踏み込んだ爪先を削られ、胸の傷からの血飛沫が蒸発し、格子状に塞がれた帯の隙間に矮躯をねじ込んで幕引きを拒絶。どうだどうだ、見たことか。これが大人の体であったなら隙間を潜れなかったはずなので色々差っ引いて今のCecilusの勝ち。
...
"ここで想像力を羽ばたかせる！"
 ...
 戦闘の最中の思考の加速は目覚ましく、ここまでの大立ち回りを絶賛喝采大歓声。しかしこのままではジリ貧退屈総スカンと、Cecilusはベストな演出プランを導き出すために全身の機能を舞台映え優先にギアチェンジ。
...
"--さて"
 ...
 と、そう一息を挟み、白黒の世界--金剛石の帯の猛攻を躱し続ける空間で、Cecilusは見栄えよく奮闘する自分を文字通り俯瞰している。

 思考の加速を空想的に表現し、刹那を引き延ばしているような感覚。とはいえこれも万能ではない。花形役者は場を持たせる技にも長けていようが、状況が動かなければ観客を魅せ続けるにも限度がある。物語は動いてこそ、心を揺すぶるのだ。

 あの金剛石のヒロインに泣きながら懇願され、それはそれは腹を立ててしまったCecilusではあるが、あの訴えの真意を自分に都合よくこじつけて、このスローモーだがゆっくり着実に進行している状況を動かす推進力を得なくては。
...
"----"
 ...
 普通に考えれば、彼女はCecilusの関係者なのだ。もしかすると、有名すぎるCecilusを一方的に知っているコアなファンの可能性もあるが、仮にそうでもここから先の思考には問題がないので、そこの正否は問わないでおく。

 ここで重要なのは、彼女が意識するCecilus Segmuntというのが、今の自分ではなくて、色々と話題に上るお騒がせなビフォア・Cecilusということだ。

 余人が聞けば呆れるだろうし、実際にSchwartzやTanzaは呆れていたが、そのビフォア・Cecilusの話はCecilusの興味を全く惹かなかった。



 何を言われても他人事、何を為そうと他人の空似、何を残そうと誰かの褌。

 それがCecilusの感覚であり、故にはっきりとCecilusの中ではビフォアとアフターの住み分けは完了している。どうやらそれは拾い食いが原因であっぷあっぷ状態の疑惑があるヒロインも同じ感覚であるらしい。

 ヒロインは、ビフォア・Cecilusとアフター・Cecilusを同一視していない。
...
"どうしたことでしょうね。別物と分けて考えてもらえてるのはありがたいにも拘らず必要とされているのがこの僕でないことにははっきり不満を感じます"
 ...
 うんうんと考え込むCecilusの横に、ぴょこんと別のCecilusが顔を出す。

 今、ビフォアとアフターのCecilusは別と言い切ったところなのに、ここでアナザー・Cecilusが出てくるのはややこしいが、話し相手がいると捗るのも事実。
...
"ヒロインの話というよりは彼女に対する僕のスタンスの話だと思いますね。もちろんボスやTanza-sanを見ていれば物語における重要人物とそのヒロインとの関係性がそれまでになかったケミストリーを生み出すことは想像に難くありませんが"
...
"そんな気がしてきました。しかしそうなるとあれですね。--僕の直感は今この瞬間の僕というCecilus Segmunt以外を頼られるのがなんかなーって思ってますね"



"なるほど。ですが彼女が求めているのは今の僕ではないという話でしたね。乞われているのはビフォア・Cecilusですがその理由はアフター・Cecilusにはビフォア・Cecilusならできるだろうってことができないと思われているからでは？"
...
"異議なーし！"
 ...
 二人のCecilusで頷き合い、お互いが納得のいく合意に達し、そのままどちらが俯瞰されているリAl Cecilusへ戻るかで一悶着が起こる。

 ここにどちらが真のCecilusの魂なのかを決める不毛な戦いが始まり、終わり--直後にリAl Cecilusの時が通常速度で動き始め、天女の羽衣が放つ十二の金剛石が生み出す死線、それへの対処が再開する。
...
"--ゆっくりに見えてたから体感速度が速い速い速い！"
 ...
 踊る十二の光帯は、それぞれが意思があるように独立し、普通の武器とは違って生き物のように不規則な軌道を成立させる。手刀で打ち落とそうと試みたら触れた部位がごっそり抉れて視覚的に痛い。切れ味はRowanが後生大事にしている«オニバミ»よりもはるかに上と見て取れて、これはなかなかハードな敵だ。

 ただ、致死性の高い美しき宝石群に囲まれながらCecilusは思う。



"殺してというあの言い方、彼女の頭の中のCecilusならできるという考え"



 それはつまり、彼女の頭の中のCecilusならば、この金剛石の包囲網も容易く突破して自分に辿り着いた挙句、見事に心の臓を止めてみせるという信頼の表れだ。

 当然だが、前のCecilusを超えるつもりのCecilusはその上をゆくのが必須条件--、
...
"当たれない触れないビフォア僕がやってないやつならこうしては？"
 ...
 用意した自分越えのハードルのため、Cecilusの思考がスパークする。

 ビフォア・Cecilusであれば押し寄せる攻撃を丸ごと回避したかもしれないが、アフター・Cecilusとアナザー・Cecilusが融合を果たしたパーフェクト・Cecilusであれば躱すだけではない見せ場を作る。
...
"これぞ光のアヤトリ！"
 ...
 Gladiator Islandからの旅の道中、Schwartzが手慰みに披露した糸遊びで、珍しくTanzaが手放しに感動してSchwartzがマジ照れしていたものを再現した。
...
"僕は僕を超えられる"
 ...
 しかし、Cecilusが頭の中で思い描いたビフォア・Cecilusには、この«トーキョータワー»は作れなかった。彼の中には«トーキョータワー»がないのだから。

 なのでビフォア・Cecilusも躱し切ったかもしれないが、躱し切る以上の見せ場作りに成功したのでその分、今のCecilusが一歩リード。
...
"----"
 ...
 確信の直後、Cecilusの真下で光の«トーキョータワー»の構成がほどける。
...
"あなたも相当な負けず嫌いですね！"
 ...
 相変わらず色はなく、自分の声さえも鼓膜に無視させた世界で、Cecilusはそれを仕掛けたヒロインを遠目に見ながら感心した。
...
"--あった"
 ...
 体中の神経を剥き出し、風に当てるような超次元の蛮行を行いながら、上昇中のCecilusの伸ばした足が何かに当たった。

 都合のいい壁や建物ではない。当たったのは、Cecilusとヒロインの戦いに巻き込まれて壊れていく街並み、そこから舞い上がった瓦礫の破片、一粒の小石だ。
...
"し"
 ...
 足裏に当たった微かすぎる感触を足場に、Cecilusの体が空中で跳ねる。

 上がってくる無色の破壊に追いつかれないよう、Cecilusはさらに、巻き上げられた木片や割れた窓ガラス、ついには大きめの灰を踏んで高く逃れた。



 何故できるのか。できるからできると、見たものを信じさせる。

 様々な道理や概念を無視し、空へ逃れるCecilusのそれは常識への暴挙だ。それを目にしたものは奇跡と呼ぶかもしれないが、Cecilusに言わせればこの程度は序の口、日常様々な瞬間に訪れ、世界を彩っていく奇跡の一握に過ぎない。
...
"焦れて現実が牙を剥く"
 ...
 理不尽な上昇で光芒から逃れるCecilus、その逃亡の正否が結果として出る前に、無色の光芒を内側から食い破り、再構築された光帯が空のCecilusへ追い縋った。

 十二の帯は螺旋状に絡まり合いながら、Cecilusへ向けて先端を放射状に広げ、まるで食虫花が美しい花弁で羽虫を捉えるように喰らいつく。蕾のように閉じられる花弁、金剛石の花に呑まれかけるCecilusに逃れる術はない。

 それもたぶん、きっと、今のCecilusでないCecilusだったなら。
...
"ドン"
 ...
 生憎、音をシャットアウトしているCecilus自身には聞こえなかったが、この場に居合わせているヒロインやAlの鼓膜には悪いことをした。もっとも、一番文句を言いたくなったのは、Cecilusに蹴られ、爆発させられた空の方だろう。



 音を置き去りにし、雷速で走ることのできるCecilusは空気に壁があることを知っている。その壁を蹴るのは簡単ではないが、見せ場でしくじるような大根役者と侮ってもらっては困る。ぶっつけ本番だろうと、完璧に魅せてこそ花形役者。



 結果、爆発音と共に、Cecilusの体は今度は真下に射出される。一気に急降下し、金剛石の花の蕾が閉じ切るより早く、花弁を逃れて地上へ落ちる。

 真っ直ぐ地面に突き刺さったCecilusは、まさしく落雷の如き衝撃を生んだ。
...
"--十歩"
 ...
 その走り出したCecilusを狙い、一度は閉じた蕾が再び広がり、金剛石の花弁が胞子を散らせるように降り注いでくるのを、大きな一歩で置いていく。
...
"--九歩"
 ...
 Cecilusの左右の空間が歪み、ねじくれたそこから石柱が飛び出す。
...
"--七歩六歩、以下省略！"
 ...
 不測の事態に臨機応変、歩数のカウントをリセットし、アフター・Cecilusを拒むように構築された石柱の嵐を掻い潜り、無限に思える距離をゼロに近付ける。



 自分の認めた、自分に届き得るCecilus以外は近付けないと猛威を振るうヒロイン。

 その強情で頑ななヒロインに、今の自分でも届いてみせると証すのに息巻くCecilus。



 それはまさしく、世界有数、帝国史上に残るレベルの危険で破滅的な意地の張り合いだ。

 その意地の張り合いを制し、Cecilusは成し遂げる。
...
"----"
 ...
 石柱の嵐を抜けて、自分を見上げるCecilusへとヒロインは光帯を再度向けた。瞬間、射程を大きく取りながら広がった光帯の先端がわずかに閃き、極薄のそれをさらに分かち、十二から二十四、二十四から四十八、四十八から九十六、九十六から百九十二、百九十二から三百八十四、三百八十四から--、
...
"----"
 ...
 --天へ伸ばしたCecilusの手に、最高のタイミングで小道具が届いた奇跡。
...
"----"
 ...
 己の髪をまとめたCecilusが、Alにはわからない理屈で気持ちを切り替えた直後、戦いはAlの介入を鼻で笑う領域へさらに加速してしまった。

 元々、自分にできることはほとんどないとわかり切っていた戦場だ。

 定義した領域の中で、二百回近い試行錯誤をしても介入できた機会はたったの二回。その二回に意味は確かにあったが、さらにギアの上がった戦いにあっては、Alが介入するチャンスなど、ただの一度も巡ってこなかった。



 そもそも、ArakiyaがCecilusを狙った攻撃の余波にすら耐えられない。

 魔晶石による異形化が進む以前の、湧き上がるマナを無造作に撃ち出していただけの攻撃と異なり、今のArakiyaの攻撃は明らかに洗練されたものとなっている。その振るわれる破壊の力--光の帯とでも呼ぶべきものが辺り一帯をめちゃくちゃにする過程で、巻き添えになったAlが消し飛ぶこと二千回以上だ。



 ただ居合わせるだけで命取りとなる戦いに、何をどうしろという話である。

 しかし、一切の介入を投げ出し、戦場から離れる選択肢も取れなかった。このままでは、CecilusはArakiyaに届く前に光の帯に殺されるからだ。



 変わらない結果を変えるため、Alは介入できる余地を探し--巻き添えを重ねた。何度も何度も、何百回も何千回も繰り返し、気付いた。

 位置取りの問題や、迂闊に気を引いたAlが虫を払うぐらいの感覚で帯の一本に消し炭にされることもあるが、CecilusがArakiyaの目の前に辿り着くところまで何とか見届けられたなら、不可避の攻撃に晒されるCecilusの不可解な動きが見えた。



 --Arakiyaの纏った光の帯が絶望的な数に枝分かれして降り注ぐ直前、Cecilusが天に向かって手を伸ばすのだ。
...
"----"
 ...
 最初、AlはそこからCecilusが渾身の手刀でも放つのかと思った。しかし、Cecilusの右手は光の雨が降り注ぐ瞬間も動く素振りを見せなかった。

 それが手刀ではなく、五指を広げているのだと気付いたのは数百回もあとだ。

 手刀でも拳でもなく、開いた掌を天に向けていた。意味がわからなかった。ここへきて急に魔法を使い始めるサプライズも検討したが、どのみち、その魔法の不発のままCecilusが煌めきに呑まれ、Alも巻き添えで消し飛ぶのは同じだった。
...
"----"
 ...
 これだけAlが必死になっているのに、件のCecilusは振り向きもしない。ArakiyaもAlを一顧だにしていない。無性に腹が立ってくる。
...
"----"
 ...
 それは不意に頭を掠めた可能性で、Alはそれをすぐに首を振って否定する。
...
"----"
 ...
 徹底的に、Alは芽生えた可能性に縋ってみることにした。

 Cecilusがあらゆる攻撃を躱し、Arakiyaの前へと辿り着く。Arakiyaが纏った煌めく光の帯が無数に枝分かれし、それが降り注いできて光が世界を呑み込む終幕。

 この終幕までの間を、何度も何度も繰り返し繰り返し、何が起きているのかを完全に把握するために、挑み続けた。



 途中、Cecilusが光の帯を舐めていることに気付いてドン引き。

 途中、Cecilusが何もない空間を蹴って飛んだことに気付いてドン引き。
 ...
 Cecilusは、あるいは、もしかすると、ややもすると--、



 --Cecilusが天に手を伸ばしているのは、見せ場を作ったのかもしれない。
...
"--いけよ、千両役者"
 ...
 天へ掲げられたCecilusの手に、一万二千二百八十八回目の正直--投げ込まれたBlue Dragon Swordの柄が、強く強く握り込まれた。
 ...
 王都Lugunicaの貧民街、王国の長年抱える負債の象徴であるその場所で、盗品の商いが堂々と行われていた闇深い地と言っていい。

 王国の命運を分ける重要な品物を巡る戦い、その舞台ともなった盗品蔵は、最終的に当代の«Sword Saint»Reinhard van・Astreaの介入により、«腸狩り»Elsa Granhiertを退ける流れで倒壊する憂き目となった。



 そのとき、Reinhardが振るったのは何の銘もない、量産品の剣だった。

 特別秀でた切れ味があるわけでもなく、たまたま盗品蔵にあったものをReinhardが拝借し、戦いに用いただけの行きずりの刀剣。

 だがしかし、その一振りは«Sword Saint»Reinhardの手で振るわれることで、数ある名剣や宝剣の類ですら経験することのできない剣撃を放つ機会を得た。



 無論、並の剣がその一閃に耐え切れるはずもなく、その剣はReinhardの手の中でたちまち崩れ去り、形あるものとしての生涯をそこで閉じた。
...
«Sword Saint»がそれを果たしたならば、同格の使い手にそれが果たせぬ道理もない。
...
"--いい仕事しましたよ、Al-san"
 ...
 伸ばした手の中の感触を強く確かめ、Cecilusは奇跡を起こした男を称賛する。

 認めよう、断言しよう。この瞬間、CecilusへBlue Dragon Swordを投げ渡すのが、Alの立場でどれほどの困難が伴うものなのか、Cecilusには想像もつかない。



 人の想像力は無限大だが、無限には至れるという軽はずみな発想さえおこがましい。

 あることはわかっていても、辿り着くことができない山の頂のようなモノ--それこそ、Cecilusの目指し続ける«天剣»と相違ない夢幻だ。



 だがしかし、Alは間に合わせた。

 如何なる方法でか、Cecilusですら想像できない手段で山を乗り越えて、AlはCecilusが欲した奇跡を、この手の中に届け果たした。
...
"----"
 ...
 光の雨が、Cecilusに回避不能の«死»となって降り注いでくる。

 Cecilusほどの役者となれば、つまらぬ死に様よりも、美しく星をちりばめたような終わり方を観客が望む気持ちもわかるし、事によってはそれもありかと思わなくもないが、今は時機が悪い。思い描いている幕引きとも異なる。
...
"そのエンディングは書き直しです"
 ...
 Cecilusの体にはやや大きめのBlue Dragon Swordを、Cecilusはこの瞬間、これまでに何千何万何億回と振ってきたような、熟練の剣技へ昇華させて振り抜く。

 初めて振るう武器であろうと、Cecilusの拡大する空想視野、脳内劇場の中ではこのBlue Dragon Swordを血反吐を吐いて、汗水垂らしながら朝も昼も夜も振り続けた実績がある。ただ、その場面を描くのはCecilus的にＮＧなので、努力の結果だけをもぎ取った。



 --刹那、Blue Dragon Swordの限界を超えた雷光の一閃が、降り注ぐ光の雨を斬り消し飛ばした。



 一閃に掻き消されたのは無数に分裂した光帯だけではない。Cecilusの左右と背面を覆い、逃げ場を封じようとした石柱の密林までも木端微塵に吹き飛ぶ。

 この瞬間、Cecilus Segmuntの剣撃は、«(The) Spirit Eater»Arakiyaを--否、Vollachian Empireの大地そのものと言えるStoneMuspelを凌駕した。
...
"----"
 ...
 そして、光の雨上がりの向こう、CecilusとArakiyaの視線が交わり--、
...
"--ッ"
 ...
 放たれた十三本目の光帯を、Cecilusは首をひねって躱した。右頬を掠められ、右耳の下半分が消し飛び、こそがれた首と肩で血が蒸発するが、回避に成功。
...
"一歩--"
 ...
 そこから、Cecilusの雷速の疾駆が空のArakiyaへ迫らんと--、
...
"----"
 ...
 瞬間、躱した光帯が無色の爆発を起こし、Cecilusの頭が爆風に殴られていた。
...
«--おや？»
 ...
 不意に、夕暮れの差し込む見知らぬ部屋の中に立ち尽くし、Cecilusは首を傾げた。

 きょろきょろと辺りを見回してみるが、見覚えのない場所である。これでCecilusは忘れっぽいことに定評があるが、意外と目にした場所や物は忘れない。
...
«その僕の認識で知らない場所ではありますね。というかそもそもこういう場所にいること自体がちょっと違和感が仕事しすぎていますが»
 ...
 CecilusはundeadだらけのImperial Capitalで、泣きじゃくるヒロインに殺してとせがまれ、それにムカッ腹が立ったので過去の自分越えを決意し、AlのBlue Dragon Swordを粉々にしたはずだ。



«そこで終わると僕がAl-sanのBlue Dragon Swordを壊したのを気に病んで現実逃避しているみたいに思えてきますね。さすがにそれは……ととと»



 人の物を壊せば、Cecilusだって胸が痛む。が、物にも寿命や天運がある。機会が巡ったなら、それが壊れることもやむなしというもの。AlのBlue Dragon Swordはその類だろう。全部が丸っと片付いたあと、Schwartzにでも頼んで弁済させてもらえばいい。
...
«大人の僕ですね。とするとこれはビフォア僕の記憶？»
 ...
 その過去の自分--«Cecilus»の実在を確かめて、Cecilusは状況を推測する。

 あれだけ方々で«(The) Blue Lightning»の話題が広がっていたのだから、いないと疑うのは無理があったが、こうして本当に大きな自分を見るとなかなか感動する。

 自分越えを志していた関係上、立場的にはこの«Cecilus»はライバルのような相手のはずなのだが--、
...
«ふむふむ、いいじゃないですか！ なかなか理想的な育ち方をしましたね！ 華はそのままに色気を増して男っぷりが上がりました！»
 ...
 目の当たりにした«Cecilus»の姿に、大したものだと惚れ惚れする。

 心構えとしては今のCecilusと同じく、自分がこの世界の花形役者の気概を持ち続けていたのだろうから、心身を最高たる状態に保つのは当然のこと。
...
«はて。しかしこうして成長を遂げた僕を前にしたはいいですが先の展開が読めませんね。僕が僕を超えるという発想を実現するためにここでかつての僕と斬り合いに突入とか？ そのわりにはこちらの僕には僕が見えていないようですが……»
 ...
 ひとしきりの感動を済ませると、改めてCecilusは現状を訝しむ。

 目の前で手を振ってみても、«Cecilus»はこの場のCecilusの存在に気付かない。この光景に干渉できないなら、これの意味するところはなんなのか。
...
"--叱責かどうか、そちらに自覚がない場合もあるかと当方は考える次第ですが、心当たりがないからと安心するのは早計ではありませんかなぁ"
 ...
 次いで、聞こえてきた声は«Cecilus»に遅れて部屋に入ってくる人物だ。

 その人物は開いたままの扉を後ろ手に閉めると、先に入った«Cecilus»を見やり、その切れ長な瞳を細くする。



 それは何とも、珍妙な見た目の人物だった。

 長い白髪に白い顔、纏った衣装や手にした軍配をも白くまとめた姿かたち、«Cecilus»以上に細くて背の高い姿は、絵物語に登場する怪しい化生のそれに見える。

 その見た目からして、実にCecilus好みのインパクトだ。



"む。そう言い出すってことは僕が思い当たらないだけでやっぱりお小言ですか？ だったら僕を先に部屋に入れたのは失敗でしたね。あの窓からバーンと外に飛び出して城壁を駆け下りて逃げるだけですよ、Chisha"
...
"なんだ、驚かせないでくださいよ。まったく、Chishaときたら人が悪い。何年経っても変わりませんねえそういうところは"
...
"--。ええ、珍しく同意見ですなぁ"
 ...
 その白い人物を、«Cecilus»が気安い調子でChishaと呼んだ。

 ならば名前はChishaなのだろう男と、«Cecilus»はなかなか親しげだ。現状、CecilusにChishaとの面識はないが、年単位の付き合いであることはやり取りからわかる。その年単位も、短くない年数と«Cecilus»の台詞でわかった。
...
«ふむ»
 ...
 ざっと、«Cecilus»の年代は二十歳と一、二年の誤差といったところか。そうなると現状のCecilusとの開きは十年ほど、Chishaとはその間の関係性と窺える。

 十年というと、Cecilusの«(The) Blue Lightning»の名の広まり具合からすると、なかなか妥当な線にも感じられた。--つまり、Cecilusが見ている過去の光景は、現実でも一、二年の間に交わされたものの可能性が高い。



 それを見て取り、Cecilusはさらに思考を進め、合わせて首をひねる。
...
«縮んでるのが事実だとしてたぶん小さくなる前の記憶は封じられてるだけで消えてなくなったわけではないと思うんですよね»
 ...
 縮んだときの記憶がないので、縮むメカニズムはよくわかっていないが、Cecilusの過ごした十年をごっそりなかったことにはできないはずだ。それでも十年の記憶が思い出せないのは、肉体と精神が相互に影響し合うものだからに他ならない。



 Cecilusができると思ったことを体で実現するように、体の方が縮んだと証明したら精神の方も合わせて退行しなくてはならない。--たぶん、そんなところだ。

 なので、この記憶自体は眠っていただけで、Cecilusの中にずっとあったものなのだろうと思う。思うので、見えていること自体は問題ない。
...
«……これ、僕が縮んだときの記憶っぽいんですよねえ»
 ...
 そう、Cecilusが渋い顔でぼやくのは、嫌な可能性に思い至ったからだ。

 Cecilusは経験したことがないが、人間は死に瀕したとき、目の前に迫る死から逃れるための方法を求め、自分の人生の記憶を遡るということがあるらしい。それまでの人生の積み重ねの中に、«死»を否定する材料を探すという機能だそうだ。

 そして、Cecilusの渋い顔の答えが、まさしく目の前の光景がCecilusの命が助けるための人生のスパークなのではないかという疑惑だった。



 つまるところ、これがCecilusの考えた通り、自分が縮んだときの記憶だとしたら、その逆もまた然りという場面なのではないだろうか。
...
«ここで僕が縮むところを見て、そこから元に戻る方法のヒントを得て状況を打開しろとかってことじゃないです？ それってめちゃめちゃダサくありません？»
 ...
 自分を超えると宣言し、涙をこぼしたヒロインへ辿り着くための決死行を踏み、脇役のAlが役柄以上の最高のアシストをしたのに、自分は初志貫徹に失敗する。

 そんな自分の失態の答えが目の前にあるようで、Cecilusは心底嫌な気持ちになる。
...
«やだいやだいやだい！»
 ...
 実際、部屋の床に寝転がって、手足をバタつかせて駄々をこねてもみた。だが、そうするCecilusの抵抗は、«Cecilus»とChishaのやり取りを止められない。

 寝そべるCecilusを置き去りに、二人の話題は進んでしまう。



"何やら複雑な顔をしてますね、Chisha"
...
"あなたの口から普通などとは片腹痛い"
 ...
 笑みなど欠片も浮かばぬ顔で、そう答えるChishaに«Cecilus»が唇を尖らせる。

 その様子を、記憶に構ってもらえないCecilusが駄々っ子を諦めて胡坐で見上げる。友人とは、自分で言うのもなんだが自分にいるのが意外の極み。

 SchwartzやTanza、Gustavやプレアデス戦団のものたちは、Cecilusにとって味方であっても友人や家族ではない。その自分に友人とは。

 しかし、そのCecilusの感慨も余所に、ふと遠い目をしたChishaが"Cecilus"と«Cecilus»のことを呼び、
...
"閣下とChishaが？ 話し合えることなら話し合えばいいし話し合ってどうにもならないことなら雌雄を決するしかないのでは？"
...
"もちろん閣下の味方です。言うまでもないことでしょう？"
 ...
 忌憚なく、気負いなく、«Cecilus»は声の調子を変えずに淡々と答える。そのまま、彼は奥の机にひょいと尻を乗せると、足を浮かせてChishaを見た。

 膝の上に頬杖をつ MANUAL CHECKき、«Cecilus»はその青い双眸を片方つむると、



"遠回しな上に不可解な仮定の話……もしやと思いますが、Chishaは何かしでかすつもりでいるんです？"
...
«"--大きな戦い"»
 ...
 Chishaの一言に反応する、過去と今のCecilusの発言が重なった。

«Cecilus»には心当たりのなさそうな話で、Cecilusもこれだと言えるほどChishaを知らない。その言葉に、Chishaは後ろ手に手を組んで窓辺まで歩いていき、
...
"Chishaと閣下が没交渉とは珍しい。珍しいというより初めてじゃありません？"
...
"ええ。ですからChishaの側が閣下を言い負かすのを諦めるのが初めてでしょ？"
...
"----"
 ...
 窓の外の景色を眺めながら、押し黙るChishaの背中に«Cecilus»が首だけ振り向く。Chishaが答えないのは、«Cecilus»の言い分が事実だからだろう。

 長い付き合いだが、あれでVincentはChishaに無茶振りばかりする。帝国始まって以来の賢帝という評判は、Chishaの血と汗と涙の上に成り立っているのだ。
...
«……むう»
 ...
 そう考えたところで、CecilusはChishaをよく知っている気がしてくる。話題に挙がる閣下についても、ぼんやりと顔が思い浮かんできた。なんだか、眉間に皺が寄っている顔だ。顔はぼやけているが、眉間の皺は特徴的で、皺が本体に思える。

 その感覚をあまり歓迎できない心境で、しかし、Cecilusは«Cecilus»とChishaの会話には興味が湧いて、成り行きを見守った。



 Chishaと閣下--Vincentとが没交渉。それから。
...
"--僕が邪魔ですね？"
 ...
 静かに、わずかに楽しげに、«Cecilus»がChishaの背に問いかける。それを受け、Chishaは無言で振り向き、白い体を浴びた夕日で橙色に染めながら目を細める。

 またしても否定はない。無言は、沈黙は、肯定の証だ。



"閣下とChishaの意見が割れて対立するなら僕は必ず閣下につきます。それは僕の大前提であり譲られることのない剣の誓いですよ"



"ええ、そう答えることは承知している次第。加えて、あなたが閣下の側に立つなら当方の勝算はなきに等しい。たとえArakiyaやOlbartGeneral First-Class……いいえ、あなた以外の«Nine Divine Generals»を全てこちらへ与させても、あなた一人に敵わないでしょう"



"ほうほうほうほう、それはそれは魅力的なお話ですね。実は僕も前々から思っていたんですよ。帝国最強軍団«Nine Divine Generals»ですが九人というのは多いのではないかと"
...
«それは僕も思いますね»
 ...
 そんな認識のCecilusと、徐々に戦意を高めつつある«Cecilus»。二人のCecilusの視線を真っ向から浴びて、Chishaの表情は崩れない。

 この顔をしているときのChishaは要注意、何かとんでもない策がある。



"生憎と、実際に«Nine Divine Generals»を口説き落とせたわけではありません"



"なんだそうですか。いやでもそうですよね。Goz-sanやMoguroが閣下を裏切るわけとかないですし。でもだったらどうするんです？"
...
"それで諦めるChishaじゃない。そういう顔ですよ？"



 沸々と蘇る懐かしい感慨、それを後押しする«Cecilus»の反応。«Cecilus»は机に尻を預けたまま、Chishaの挙動の端々に目を配っている。

 Chishaがどう動こうと制圧できる。が、それはChishaもわかっている話。

 さあ、どうするつもりなのか。どうやって、この«Cecilus Segmunt»の隙を突き、彼は自分を小さな子どもの姿へ縮めてくれるのか。



"Cecilus、あなたを盤面から排除します。当方と閣下の読み合いに、あなたの出る幕は用意しません。あなたには別の役目を用意する次第"



"そう言われてもはいそうですねと威勢のいい返事はできませんよ。かといって力ずくで僕をどけることもできないなら言葉の力で排除しますか？ この僕が帝国で一番聞く耳を持たない«将»だとChishaも知っての通りです"



 そう言って、机の上から尻を下ろして床に着地、くるっと踊るように回り、«Cecilus»がChishaと真っ向から向き合った。夕日の中に佇むChishaの姿を眩しく思いながら、«Cecilus»は体を前に傾け、上目遣いに彼を見る。



 長く付き合いがあり、互いにいいところも悪いところもよく知り尽くした間柄、そんな友人の顔を覗き込み、«Cecilus»は笑った。

 笑い、Chishaの用意したとっておきの策とやらを出せと挑発する。



"さあ、どんな聞かせる言葉や意見や理屈で僕を説得してくれます？ これは閣下に次ぐ知恵者であるChisha Goldでも難題でしょう"



 その安い«Cecilus»の挑発に、Chishaは目を閉じて一拍おいた。

 そして、その瞳を開いて、双眸に«Cecilus»を映しながら、
...
«--パーフェクト！！»
 ...
 背に夕焼けを背負いながら、執務室でChisha GoldはCecilusを打ち倒した。隙を突かれたのでも、懇々と利を説かれたのでもなく、託された。



 それが«Cecilus Segmunt»が、Cecilus Segmuntになった理由だ。
...
"--ッ"
 ...
 カッと熱い灼熱の感覚が頭を打ち、Cecilusの意識が現実へ回帰する。
...
"----"
 ...
 手の中で砕けて消えるBlue Dragon Sword、その渾身の一撃で掻き消したはずの光帯が、Arakiyaの力によって再構築され、五本、六本まで復活する。

 さしもの彼女も、あの一撃で砕かれた力をすぐに取り戻すことはできない。背負っていた魔晶石の翼もひび割れ、キラキラと破片の散る中にArakiyaはいる。



 その細い体の奥底に、喰らい込んだのはStoneMuspelか。

 Vollachian Empireの大地そのものに牙を立てるとは、その見境のなさには驚かされる。なんて、さすがのCecilusもあの涙を見てはそうは思わない。
...
"でも、あんな顔の頼み事なんてお断りですよ"
 ...
 どうしてもCecilusに頼みを聞かせたいなら、せめて精一杯笑うことだ。その選択に悔いはないと嘘のない笑顔で言われれば、Cecilusも真剣に受け止めもする。

 笑ってCecilusに縮めと命じた、あのどうしようもない友人のように。
...
"ああ、そういうことでしたか"
 ...
 今も、Cecilusの手足は短く、蘇った記憶も眠っていたものが断片的にだ。

 縮んだ体を元に戻す方法はわからない。Chishaの具体的な手法を思い出す前に記憶は終わったし、それであの回想の目的は果たされた。



 死を目前にした人間が、その打開策を自分の記憶の中に求めるという現象。あれは紛れもなく、その一例だった。ただ、打開策の答えが予想と違っただけ。

 あの回想の最後に、Cecilusは自分の体が大人に戻る方法を知るのかと思った。だが、そうではなかった。そうでなくて、よかった。



 死を目前にした人間が、その打開策を自分の記憶の中に求めた。

 あの、Chishaの顔と、頼みを聞いた。--Cecilus Segmuntが、死を拒絶できる根拠には十分すぎる理由だ。
...
"そもそも僕が負けるわけありませんしね"
 ...
 Cecilusには自分の哲学で、ここでArakiya相手に負けないという答えがあった。
...
"--ボスがいません。僕がここで死ぬことがあるのなら約束なんて平気で反故にして駆け付けてくるでしょうに"
 ...
 そうこぼし、Cecilusは血濡れの美顔で苦笑する。

 Natsuki・Schwartzはそういう少年だ。Gladiator Islandから旅立ち、プレアデス戦団を名乗って東征する最中、月下でCecilusとSchwartzは約束を交わした。

 Schwartzの奇跡のような«物見»の力で、Cecilusを救わないでくれと。

 互いを尊重すると約束をしたが、Cecilusにはわかる。Schwartzはいざとなれば平気で約束を破る。Cecilus自身がそうだ。Schwartzも同じ手合いだ。

 だから、わかるのだ。



 Cecilusが死ぬと«物見»で見たら、Schwartzは必ずここへ駆け付けた。

 それがない。それをSchwartzからの信頼と、そう言い換えてもいい。

 そして、同じものはCecilusからSchwartzへ向けるものとしてもある。
...
"----"
 ...
 横紙破りな確信を得たCecilusへ、六本の光帯が猛然と閃いて迫る。

 すでに宙にあり、次なる動きを生むのが難しいCecilusには躱せない。だが、躱せなくともできることがある。それは、一瞬の白昼夢から持ち帰った切り札だ。



 --Blue Dragon SwordをなくしたCecilusの手に、別の刀の柄が握られている。
...
"--マサユメ"
 ...
 銘を呼ばれ、刀身の刃紋を波打つように揺らすのは一振りの魔剣。それはCecilus Segmuntが有する強大な力を持った«夢剣»マサユメ。

 在処のわからぬとRowanが嘆き、もう一振りの«邪剣»ムラサメと同じく、この世の理を超えたモノを斬ることが許された超常の剣。



 Cecilusの記憶と共に見失われ、皆が在処に頭を悩ませたのも当然だ。

«Yang Sword»Vollachiaは空を鞘とする。そして、«夢剣»マサユメは夢を鞘とする。--故にCecilusは、白昼夢の中の«Cecilus»の腰よりマサユメを拝借した。



 手の中で脈打つマサユメは、矮躯のCecilusが所有者であると認めている。これがムラサメならこう容易くはいかない。巡り合わせにこの場は感謝だ。
...
"狙うは--"
 ...
 それを調伏する。やったことはない。だが、できると信じ、実現する。その力がCecilusにはある。マサユメも頼もしい。目撃者のAlもいる。しくじれない燃えてくる。
...
"夢は起きて見るもの、魅せるものですよ、アーニャ"
 ...
 そう口にして、Cecilusは引き延ばされる超速の中にArakiyaの双眸を見る。光のない左目から血涙を流し、いつも以上に感情の読み取りにくい顔をした美しい少女。
...
"--あなたが大事に想う人も、あなたを大事に想っていますよ"
 ...
 --それがCecilus Segmuntの、ヒロインの懇願への答えだった。"""

test_input_as_list = list(test_input.splitlines(keepends=False))
expected_output_as_list = list(expected_output.splitlines(keepends=False))
replacements_file_path = os.path.join(os.path.dirname(os.getcwd()), 'replacement_table', 'rezero.json')

if __name__ == "__main__":
    preprocessed_text = preprocess.preprocessor.run_nlp_mtl_preprocessor(
        input_string=test_input,
        path_to_replacements_table=replacements_file_path,
        verbose=True)
    if preprocessed_text == expected_output:
    ...
    preprocessed_list = [preprocess.preprocessor.run_nlp_mtl_preprocessor(line, replacements_file_path, tokenizer) for line in test_input_as_list]
    if set(preprocessed_list) == set(expected_output_as_list):
